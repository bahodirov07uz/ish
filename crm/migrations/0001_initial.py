    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ishlari', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='oylik_ishlari', to='crm.eskiish', verbose_name='Ishlar')),
            ],
            options={
                'verbose_name': 'Oylik',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('teri_sarfi', models.DecimalField(decimal_places=2, default=0, help_text='1 ta mahsulot uchun teri sarfi (kg, m2 yoki dona)', max_digits=10, verbose_name='Terı sarfi')),
